...
class XLSXWriter
{
	 ...
	 * 
	 * @param string $sheetName
	 * @param unknown $startCellRow
	 * @param unknown $startCellColumn
	 * @param unknown $endCellRow
	 * @param unknown $endCellColumn
	 */
